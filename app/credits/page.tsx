      ...
      <div className="relative z-10 w-full h-full flex flex-col items-center  justify-center overflow-hidden text-white font-sans">
        <div
          className={`flex flex-col items-center transition-transform mt-[100rem] duration-[60000ms] ease-linear ${
            isVisible ? "-translate-y-full" : "translate-y-1/2"
          }`}
          style={{
        ...
        >
          ...
          <div className="py-8 text-center">
            ...
            <div className="mb-16">
              <p className="text-lg mb-2">SPONSORED BY ABSOLUTELY NO ONE, BUT STILL</p>
              <p className="text-4xl font-bold">HIMANSHU HEGDE</p>
            </div>
            ...
            <div className="mb-16">
              <p className="text-lg mb-2">GENERATED BY AI, BUT STILL CLAIMED BY</p>
              <p className="text-4xl font-bold">HIMANSHU HEGDE</p>
            </div>
            ...
            <div className="mb-24">
              ...
              <div className="mb-16">
                ...
                <div className="mt-4">
                  {Array(100)
                    .fill(" Himanshu Surrrr")
                    .map((name, index) => (
                      <p key={index} className="text-5xl font-bold my-14">
                        <span className="text-5xl mb-4">Special Thanks To </span>
                        {name}
                      </p>
                    ))}
                </div>
              ...
              <p className="text-5xl font-bold my-14">
                        ...
                        <br/>
                        <span className="text-9xl mb-4"> Himanshu Surrrr</span>
                      </p>
              </div>
              ...
              <p className="text-sm mt-16 mb-32">
