      ...
      <div className="w-full max-w-md mx-auto p-6 bg-black rounded-lg shadow-lg relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <motion.div
            ...
            initial={{ opacity: 0 }}
            animate={{ 
              opacity: [0, 0.05 * glitchIntensity, 0, 0.03 * glitchIntensity, 0]
            }}
            transition={{
              duration: 0.2,
              repeat: Infinity,
          ...
          <motion.div
            ...
            initial={{ opacity: 0 }}
            animate={{ 
              opacity: [0, 0.03 * glitchIntensity, 0, 0.05 * glitchIntensity, 0]
            }}
            transition={{
              duration: 0.3,
              delay: 0.1,
          ...
          {Array.from({ length: 3 * glitchIntensity }).map((_, i) => (
            <motion.div
              key={`glitch-line-${i}`}
              className={`absolute h-1 ${i % 2 === 0 ? 'bg-red-500' : 'bg-green-500'} left-0 right-0`}
        ...
        <div className="relative z-10">
          <h2 className="text-2xl  font-mono font-bold text-center text-green-500 mb-6">COUNTDOWN TERMINAL</h2>
          ...
          <div className="relative bg-black border-2 border-gray-700 rounded-lg p-6 mb-6">
            <motion.div
              ...
              animate={timeRemaining === 0 ? {
                ...
                x: timeRemaining < initialTime * 0.2 ? [-1 * glitchIntensity, 1 * glitchIntensity, -1 * glitchIntensity, 0] : 0
              }}
              transition={{
                duration: 0.3,
          ...
          <div className="mb-6">
            <div className="flex justify-between items-center mb-4">
              <span className="font-mono text-gray-400">Set Timer (seconds):</span>
            ...
            <div className="flex justify-between gap-4">
              ...
              <Button
                onClick={resetTimer}
                className="flex-1 bg-gray-700 hover:bg-gray-600 text-white font-mono"
              >
          ...
          <div className="font-mono text-xs text-gray-500 flex items-center justify-center">
            ...
            <span>
              {!isRunning && timeRemaining === 0 ? 'EXPIRED' : 
               !isRunning ? 'STANDBY' : 
               glitchIntensity >= 4 ? 'CRITICAL' : 
               glitchIntensity >= 3 ? 'WARNING' : 
               'RUNNING'}
            </span>
          </div>
        </div>
