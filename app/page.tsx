...
export default function Home() {
  ...
  const initialPlayers: Player[] = Array.from({ length: 50 }, (_, i) => ({
    ...
    eliminated: false,
    checked: false,
    blank: i%5==0?true:false, // Initially all positions are filled
  }));
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-5 md:grid-cols-10 gap-2">
          {players.map((player, index) => {
            ...
            // Replace the condition block for blank and not eliminated players with this code:
            ...
            // Add this component right before the return statement in your main component
